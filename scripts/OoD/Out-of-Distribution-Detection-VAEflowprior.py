...
#'params_fmnist_-1_40_infoGAN_VAE_best_params_noaugment_no_dropout_flow_prior_full_sigmaVAE_beta1'
...
def get_ELBO_2(features, posterior=posterior, flow_prior=nvp_funcs):
    ...
    sample_likelihood = likelihood(posterior_sample).log_prob(features)
