...
def load_binarized_mnist(dir_path,flatten=True,params=None,load_to_memory=False):
    """
    ...
    * ``'length'``
    ...
    """
        ip.save(os.path.join(params['data_dir'],ood_set+flip+'_VAE40_encoded.npy'),encoded_OOD)
...
def load_fmnist(data_dir,flatten=True,params=None):
    ...
    x_train = data['train']['images'].reshape((-1,28*28))[0:50000]
    x_valid = data['train']['images'].reshape((-1,28*28))[50000:60000]
    ...
    y_train = data['train']['labels'][0:50000]
    y_valid = data['train']['labels'][50000:60000]
