...
class Model(nn.Module):
    def __init__(self, code_length):
        ...
        self.encoder = Encoder((1,28,28),code_length=code_length)
        self.decoder = Decoder(code_length=code_length, deepest_shape=self.encoder.deepest_shape, output_shape=(1,28,28))
